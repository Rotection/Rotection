...
interface Game {
  ...
  safetyScore: number;
  ageRating: string;
  ratings: { honesty: number; safety: number; fairness: number; ageAppropriate: number; };
...
export function GameCard({ game }: GameCardProps) {
  ...
  const averageRating = ((game.ratings.honesty + game.ratings.safety + game.ratings.fairness + game.ratings.ageAppropriate) / 4).toFixed(1);
